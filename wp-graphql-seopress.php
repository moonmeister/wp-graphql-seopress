			...
			array(
				...
				'resolve' => function () {
					...
					$seopress_titles_settings = array(
						...
						'noindex'                 => $seopress_titles_options['seopress_titles_noindex'] ? true : false,
						'nofollow'                => $seopress_titles_options['seopress_titles_nofollow'] ? true : false,
						'noodp'                   => $seopress_titles_options['seopress_titles_noodp'] ? true : false,
						'noimageindex'            => $seopress_titles_options['seopress_titles_noimageindex'] ? true : false,
						'noarchive'               => $seopress_titles_options['seopress_titles_noarchive'] ? true : false,
						'nosnippet'               => $seopress_titles_options['seopress_titles_nosnippet'] ? true : false,
						'nositelinkssearchbox'    => $seopress_titles_options['seopress_titles_nositelinkssearchbox'] ? true : false,
						'paged_rel'               => $seopress_titles_options['seopress_titles_paged_rel'] ? true : false,
						'paged_noindex'           => $seopress_titles_options['seopress_titles_paged_noindex'] ? true : false,
						'attachments_noindex'     => $seopress_titles_options['seopress_titles_attachments_noindex'] ? true : false,
					);
